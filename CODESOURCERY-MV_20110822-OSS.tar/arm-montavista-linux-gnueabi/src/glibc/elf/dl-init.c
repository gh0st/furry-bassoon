...
void weak_function (*__dl_init_trace) (const ElfW(Addr) addr, const char *name,
...
call_init (struct link_map *l, int argc, char **argv, char **env)
{
  ...
  /* Call the debugging hook before running any code from the newly-loaded
     object.  */
  if (__dl_init_trace != NULL)
    (*__dl_init_trace) (l->l_addr, l->l_name, l->l_phdr, l->l_phnum);
